...
WIDTH_PROFILES = Literal["uniform", "tapered", "pressure"]
LINE_ROLES = Literal[
    "art",
    "construction",
    "center",
...
def create_tools(mcp):
    ...
    @mcp.tool(
        name="create_line_pattern",
        description="Create common artistic line types and shading-line fields. "
        "Supports straight/curve/wavy/zigzag/spiral strokes, hatching, cross-hatching, "
        "contour hatching, scribbling, and stippling. Use width_profile='tapered' "
        "or 'pressure' to create a true variable-width filled ribbon instead of a "
        "uniform SVG stroke. Use role='construction'/'center'/'gesture'/'implied' "
        "to get appropriate opacity/dash defaults for structural and expressive lines.",
    )
    def create_line_pattern(
        ...
        dash: str | None = None,
        width_profile: WIDTH_PROFILES = "uniform",
        ...
        """Create procedural linework.

        Args:
            pattern: Line pattern to generate.
            points: Control points for straight/curve/wavy/zigzag lines.
            bounds: [x, y, width, height] for hatch/scribble/stipple fields.
            center/radius/turns: Spiral controls.
            count/density: Number of generated segments or dots.
            amplitude/frequency: Wave or zigzag strength.
            jitter: Random coordinate variation in normalized units.
            stroke_width/start_width/end_width: Canvas-pixel widths.
            width_profile: "uniform", "tapered", or "pressure".
            role: Semantic line role; adjusts default opacity/dashes.
        """
        scene = get_graph()
        try:
